...
| 個人を特定できない**粗い**対象規模だけを確認できる | ❌ 現在は**正確な人数**を返している（差分攻撃が成立する） | **011** |
| 匿名性を満たす対象へだけ配信できる | ❌ **最小人数の下限がない**（1人でも配信できる） | **011** |
| 拒否を推測できない、時間固定・丸め済みファネル | ❌ 現在は**正確・リアルタイム・抑制なし** | **011** |
